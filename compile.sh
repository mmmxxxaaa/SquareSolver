...
g++ main.cpp io.cpp equation_solver.cpp logic_functions.cpp my_assert.cpp logic_functions_test.cpp \
    equation_solver_test.cpp global_test.cpp -o SquareSolver \
